...
async function notifyBuy(ctx, channel, postId, data) {
    ...
    let caption = '<i>You have selected</i> ' + itemLink + ' <i>from</i> @' + channel + '. <i>THE SELLER HAS BEEN NOTIFIED that you want to buy this item. You can contact them or they may contact you.</i>\n\n' + data.caption + '\n\n' + contactText
    // to the customer
