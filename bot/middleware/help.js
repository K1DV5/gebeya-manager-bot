...
let helpDetails = {
    ...
    settings: 'Command /settings\n\nThis command lets you customize some aspects of your channels. It has five components:\n\n<b>\u2022 Logo</b>: Here, you can set the logo of the channel that will be used to watermark the photos posted on it.\n<b>\u2022 Caption template</b>: You can set the template used to make the caption of the collage of the new item. You can include anything as long as you include the necessary components in any order.\n<b>\u2022 Contact text</b>: This is the text added on the caption of the item sent to the customer when they select "Buy" on an item.\n<b>\u2022 Sold template</b>: You can set how you want the caption to change when it is marked sold. It can contain anything as long as it contains the caption placeholder.\n<b>\u2022 Description bullet</b>: This setting lets you change the character(s) that replace the "." (dot) in the line beginnings of the description. This means you can list e.g. features of the item indicating the list items with . and it will replace the dot with whatever you define in this setting. The default is the bullet character (like in this text.)',
